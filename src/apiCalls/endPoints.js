export const characters = 'https://last-airbender-api.herokuapp.com/api/v1/characters'
export const character = '/api/v1/characters/${CharacterId}'
...
export const randomCharacters = '/api/v1/characters/random'
